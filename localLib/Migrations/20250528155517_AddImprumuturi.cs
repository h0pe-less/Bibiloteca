...
{
    /// <inheritdoc />
    public partial class AddImprumuturi : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImprumutId = table.Column<long>(type: "bigint", nullable: false)
                    ...
                    Grupa = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DataImprumut = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataReturnare = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CarteId = table.Column<long>(type: "bigint", nullable: false),
                    EsteReturnat = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Imprumuturi", x => x.ImprumutId);
                    table.ForeignKey(
